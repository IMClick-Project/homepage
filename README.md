...
IMClick-Project es una página web básica desarrollada con HTML como proyecto en el curso "Course Frontend" de DEV.F, cuyo objetivo es presentar una iniciativa personal para compartir recursos académicos de manera clara, accesible y práctica.

El proyecto está enfocado en tres áreas principales:
